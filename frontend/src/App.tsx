...
import PlutusKnowsPanel from './components/plutus/PlutusKnowsPanel'
...
function App() {
  ...
  const [plutusOpen, setPlutusOpen] = useState(false)
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Plutus — your market research control center
            </p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => setPlutusOpen(true)}
                    className="inline-flex items-center gap-1.5 text-sm px-3 py-1.5 rounded-md border border-border hover:bg-accent transition-colors">
